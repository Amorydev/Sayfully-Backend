...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        GrammarExample.objects.create(
            ...
            ipa="/aɪ æm ˈhæpi təˈdeɪ/",
            text_vi="Hôm nay tôi rất vui.",
        )
        ...
        dlg, _ = Dialogue.objects.update_or_create(
            ...
            defaults={
                ...
                "context_vi": "An gặp Ben trong lớp học buổi sáng.",
            },
        )
        ...
        lines = [
            (
                ...
                "/ɡʊd ˈmɔːnɪŋ! ɑːr juː ə njuː ˈstjuːdənt?/",
                "Chào buổi sáng! Bạn là học sinh mới à?",
            ),
            (
                "Ben",
                True,
                "Yes, I am. My name is Ben.",
                "/jes, aɪ æm. maɪ neɪm ɪz bɛn/",
                "Đúng vậy. Mình tên là Ben.",
            ),
            (
                "An",
                False,
                "Nice to meet you, Ben. I am An.",
                "/naɪs tə miːt juː, bɛn. aɪ æm æn/",
                "Rất vui được gặp bạn, Ben. Mình là An.",
            ),
            (
                "Ben",
                True,
                "Nice to meet you too. I am happy to be here.",
                "/naɪs tə miːt juː tuː. aɪ æm ˈhæpi tə biː hɪər/",
                "Mình cũng vậy. Mình rất vui khi ở đây.",
            ),
        ]
            ...
            payload={
                ...
                "preview": [
                    ...
                    },
                    {
                        ...
                        "text_vi": "Rất vui được gặp bạn.",
                    },
                    {
                        "text_en": "I am happy to be here.",
                        "ipa": "/aɪ æm ˈhæpi tə biː hɪər/",
                        "text_vi": "Tôi rất vui khi ở đây.",
                    },
                ],
            },
        )
        ...
        quizzes = [
            (
                "morning",
                "/ˈmɔː.nɪŋ/",
                ["buổi sáng", "buổi tối", "buổi trưa", "ban đêm"],
                0,
                "morning = buổi sáng",
            ),
            (
                "friend",
                "/frend/",
                ["bạn bè", "kẻ thù", "thầy giáo", "hàng xóm"],
                0,
                "friend = bạn bè",
            ),
            ...
            (
                "student",
                "/ˈstjuː.dənt/",
                ["học sinh", "giáo viên", "bác sĩ", "kỹ sư"],
                0,
                "student = học sinh",
            ),
        ]
